...
case $(hostname) in
    "ux1104")
        ...
        # portrait
         xrandr --auto --output 'HDMI-1' --mode '1920x1200' --rotate 'left' --left-of 'DVI-I-1' --output 'DVI-I-1' --mode '1680x1050'
        ;;
    "ux1224")
    ...
    "ux1402")
        ...
        # portrait
        xrandr --auto --output 'DP-1' --mode '1920x1200' --rotate 'left' --output 'HDMI-2' --right-of 'DP-1' --mode '1680x1050'
        ;;
    "ux1105")
